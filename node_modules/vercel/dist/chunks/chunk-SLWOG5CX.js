...
import {
  routesCommand
} from "./chunk-4LDQIDKG.js";
import {
  metricsCommand
} from "./chunk-NIOGCTVR.js";
import {
  devCommand
} from "./chunk-HAJ2XRTQ.js";
import {
  activityCommand
} from "./chunk-GCKUEAUE.js";
import {
  alertsCommand
} from "./chunk-3NSIZGHP.js";
import {
  listCommand
} from "./chunk-ONYQGA2O.js";
import {
  buildCommand,
  pullCommand
...
var listSubcommand4 = {
  name: "list",
  aliases: ["ls"],
  description: "List Connex clients linked to the current project (falls back to every client in the team when no project is linked or when --all-projects is set)",
  arguments: [],
  options: [
    {
      name: "all-projects",
      ...
      type: Boolean,
      deprecated: false,
      description: "List every Connex client in the team, regardless of project link"
    },
    {
      name: "limit",
      shorthand: null,
...
var attachSubcommand = {
  name: "attach",
  aliases: [],
  description: "Attach a Vercel project to a Connex client for one or more environments",
  arguments: [
    {
      name: "client",
      required: true
